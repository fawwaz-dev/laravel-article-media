    ...
    <div class="mx-auto max-w-4xl">
        ...
        <div class="rounded-lg border border-gray-200 bg-white shadow-sm">
            <div class="border-b border-gray-200 px-6 py-4">
                ...
                <p class="mt-1 text-sm text-gray-600">Fill in the details below to create a new article.</p>
            </div>

            <form action="{{ route('articles.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6 p-6">
                @csrf
                        ...
                        <div id="upload_content" class="space-y-1 text-center">
                            <svg class="mx-auto h-12 w-12 text-gray-400" stroke="currentColor" fill="none"
                                ...
                                <path d=" M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0
                                                            ...
                                                            4m4-24h8m-4-4v8m-12 4h.02" stroke-width="2"
